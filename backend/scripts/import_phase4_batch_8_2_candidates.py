...
PACK_PATHS = (
    DATA_DIR / "programs" / "hkust_msc_information_technology_2027_v1.json",
    DATA_DIR / "programs" / "hkust_msc_artificial_intelligence_2027_v1.json",
)
FIXED_IMPORT_TIME = datetime(2026, 9, 3, 8, 30, tzinfo=timezone.utc)
