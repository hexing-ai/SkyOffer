...
PACK_PATH = (
    DATA_DIR / "programs" / "manchester_msc_advanced_computer_science_2027_v1.json"
)
FIXED_IMPORT_TIME = datetime(2026, 9, 3, 12, 30, tzinfo=timezone.utc)
...
class StableIds:
    ...
    def __call__(self, kind: str) -> str:
        ...
        return f"{kind}.phase4.batch8.6.{count}"
